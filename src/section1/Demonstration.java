...
public class Demonstration {
    public static void main(String[] args) {
        ...
        ProductFactory medicineFactory = new MedicineFactory();
        ProductFactory toyFactory = new ToyFactory();

        Order order1 = new Order(customer1, LocalDate.now());
        order1.addProduct(medicineFactory, "Med Brand 1.1", "Med License 1", 20.5, "Lot 1", null);
        order1.addProduct(medicineFactory, "Med Brand 1.2", "Med License 1", 35.5, "Lot 1", null);
        order1.addProduct(toyFactory, "Toy Brand 1", "Toy License 1", 21.1, null, "Vietnam");

        Order order2 = new Order(customer2, LocalDate.now());
        order2.addProduct(medicineFactory, "Med Brand 2.1", "Med License 2", 69.9, "Lot 2", null);
        order2.addProduct(toyFactory, "Toy Brand 2", "Toy License 2", 22.5, null, "Laos");
        ...
        try {
            order1.addProduct(null, "Brand X", "License X", 1.0, null, null);
